...
func main() {
	...
	// SECOND DIMENSION (the_nether): wire a dedicated nether generator + worker + ChunkManager so a
	// player who travels to the nether (/dimension nether, or a portal) streams real nether terrain.
