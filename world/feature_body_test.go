...
func TestRegisterAndDispatch(t *testing.T) {
	...
	placer := newConfiguredPlacer(cf, view, reg, block.StateID(0), false, nil)
...
func TestUnregisteredIsNoOp(t *testing.T) {
	...
	placer := newConfiguredPlacer(cf, view, feature.NewEmbeddedRegistry(), block.StateID(0), false, &inv)
	ctx := newPlacementContext(view, -64, 384, nil)
...
func TestTestSetBlockStillWorks(t *testing.T) {
	...
	placer := newConfiguredPlacer(cf, view, nil, stone, true, nil)
	ctx := newPlacementContext(view, -64, 384, nil)
