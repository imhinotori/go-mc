...
var Map = map[string]string{
	...
	"gui.friends.presence.status.playing_hosted_server": "Въ локальной сѣти",
	"gui.friends.presence.status.playing_offline": "Въ мірѣ",
	"gui.friends.presence.status.playing_realms": "Въ реалмѣ",
	"gui.friends.presence.status.playing_server": "Въ салонѣ",
	...
	"gui.friends.validation.already_friend": "%s уже въ спискѣ друзей",
	...
	"menu.multiplayerOptions.otherPlayers.header": "Настройки для другихъ игроковъ",
	...
	"options.allowFriendRequests.tooltip": "Разрѣшить другимъ игрокамъ отправлять вамъ запросы въ друзья",
	...
	"options.exclusiveFullscreen.off.tooltip": "Въ сёмъ полноэкранномъ режимѣ работаютъ всѣ методы ввода, но адаптивная синхронизація (G-Sync, FreeSync) недоступна.",
	"options.exclusiveFullscreen.on.tooltip": "Сей полноэкранный режимъ можетъ помѣшать работѣ нѣкоторыхъ методовъ ввода, но адаптивная синхронизація (G-Sync, FreeSync) должна работать.",
	...
	"subtitles.entity.small_sulfur_cube.eat": "Сѣрный кубикъ прибавляетъ въ вѣсѣ",
