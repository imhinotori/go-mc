...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Configuracion d'accessibilitat",
	...
	"advancements.adventure.kill_a_mob.description": "Aucisètz quin mostre que siá",
	"advancements.adventure.kill_a_mob.title": "Caçaire de mostres",
	"advancements.adventure.kill_all_mobs.description": "Aucisètz cada mostre un còp",
	...
	"advancements.husbandry.uh_oh.description": "Fasetz en sòrta qu'un cube de solpre absorbisca un blòc de TNT",
	...
	"advancements.nether.ride_strider_in_overworld_lava.title": "Aver de çò de caud",
	...
	"argument.entity.notfound.entity": "Pas cap d'entitat trobada",
	...
	"argument.pos.outofbounds": "Aquela posicion es fòra dels limits autorizats.",
	...
	"attribute.name.air_drag_modifier": "Factor de resisténcia a l'aire",
	...
	"attribute.name.friction_modifier": "Factor de friccion",
	...
	"block.minecraft.cinnabar_brick_slab": "Lausa en bricas de cinabre",
	"block.minecraft.cinnabar_brick_stairs": "Escalièrs en bricas de cinabre",
	"block.minecraft.cinnabar_brick_wall": "Muret en bricas de cinabre",
	"block.minecraft.cinnabar_bricks": "Bricas de cinabre",
	"block.minecraft.cinnabar_slab": "Lausa de cinabre",
	"block.minecraft.cinnabar_stairs": "Escalièrs en cinabre",
	"block.minecraft.cinnabar_wall": "Muret en cinabre",
	...
	"block.minecraft.copper_chain": "Cadena en coire",
	...
	"block.minecraft.copper_lantern": "Lantèrna en coire",
	"block.minecraft.copper_ore": "Minièra de coire",
	"block.minecraft.copper_torch": "Entòrcha en coire",
	"block.minecraft.copper_trapdoor": "Trapa en coire",
	"block.minecraft.copper_wall_torch": "Entòrcha murala en coire",
	...
	"block.minecraft.exposed_copper_bars": "Barrets de coire expausats",
	"block.minecraft.exposed_copper_bulb": "Ampola en coire expausada",
	"block.minecraft.exposed_copper_chain": "Cadena en coire expausada",
	"block.minecraft.exposed_copper_chest": "Còfre en coire expausat",
	"block.minecraft.exposed_copper_door": "Pòrta en coire expausada",
	"block.minecraft.exposed_copper_golem_statue": "Estatua de golem de coire expausada",
	"block.minecraft.exposed_copper_grate": "Grasilha en coire expausada",
	"block.minecraft.exposed_copper_lantern": "Lantèrna en coire expausada",
	...
	"block.minecraft.golden_dandelion": "Pissalach daurada",
	...
	"block.minecraft.iron_chain": "Cadena en fèrre",
	...
	"block.minecraft.oxidized_copper_bars": "Barrets de coire oxidats",
	"block.minecraft.oxidized_copper_bulb": "Ampola en coire oxidada",
	"block.minecraft.oxidized_copper_chain": "Cadena en coire oxidada",
	"block.minecraft.oxidized_copper_chest": "Còfre en coire oxidat",
	"block.minecraft.oxidized_copper_door": "Pòrta en coire oxidada",
	"block.minecraft.oxidized_copper_golem_statue": "Estatua de golem de coire oxidada",
	"block.minecraft.oxidized_copper_grate": "Grasilha en coire oxidada",
	"block.minecraft.oxidized_copper_lantern": "Lantèrna en coire oxidada",
	...
	"block.minecraft.polished_cinnabar_slab": "Lausa en cinabre polit",
	"block.minecraft.polished_cinnabar_stairs": "Escalièrs en cinabre polit",
	"block.minecraft.polished_cinnabar_wall": "Mur de cinabre polit",
	...
	"block.minecraft.polished_sulfur_wall": "Mur de solpre polit",
	...
	"block.minecraft.potent_sulfur": "Solpre potent",
	...
	"block.minecraft.potted_closed_eyeblossom": "Uèlhquidèa barrata en pot",
	...
	"block.minecraft.potted_golden_dandelion": "Pissalach daurada en pòt",
	...
	"block.minecraft.potted_open_eyeblossom": "Uèlhquidèa dobèrta en pot",
	...
	"block.minecraft.sulfur_brick_slab": "Lausa en bricas de solpre",
	"block.minecraft.sulfur_brick_stairs": "Escalièrs en bricas de solpre",
	"block.minecraft.sulfur_brick_wall": "Muret en bricas de solpre",
	...
	"block.minecraft.sulfur_wall": "Mur de solpre",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Barrets de coire expausats encerats",
	"block.minecraft.waxed_exposed_copper_bulb": "Ampola en coire expausada encerada",
	"block.minecraft.waxed_exposed_copper_chain": "Cadena en coire expausada encerada",
	...
	"block.minecraft.waxed_exposed_copper_golem_statue": "Estatua de golem de coire expausada encerada",
	"block.minecraft.waxed_exposed_copper_grate": "Grasilha en coire expausada encerada",
	"block.minecraft.waxed_exposed_copper_lantern": "Lantèrna en coire expausada encerada",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Barrets de coire oxidats encerats",
	"block.minecraft.waxed_oxidized_copper_bulb": "Ampola en coire oxidada encerada",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadena en coire oxidada encerada",
	...
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Estatua de golem de coire oxidada encerada",
	"block.minecraft.waxed_oxidized_copper_grate": "Grasilha en coire oxidada encerada",
	"block.minecraft.waxed_oxidized_copper_lantern": "Lantèrna en coire oxidada encerada",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Barrets de coire corroïts encerats",
	"block.minecraft.waxed_weathered_copper_bulb": "Ampola en coire corroïda encerada",
	"block.minecraft.waxed_weathered_copper_chain": "Cadena en coire corroïda encerada",
	...
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estatua de golem de coire corroïda encerada",
	"block.minecraft.waxed_weathered_copper_grate": "Grasilha en coire corroïda encerada",
	"block.minecraft.waxed_weathered_copper_lantern": "Lantèrna en coire corroïda encerada",
	...
	"block.minecraft.weathered_copper_bars": "Barrets de coire corroïts",
	...
	"block.minecraft.weathered_copper_golem_statue": "Estatua de golem de coire usada",
	"block.minecraft.weathered_copper_grate": "Grasilha en coire corroïda",
	"block.minecraft.weathered_copper_lantern": "Lantèrna en coire corroïda",
	...
	"build.spawn_protection": "%s es jos la proteccion del punt de reaparicion",
	...
	"chat_restriction.chat_disabled_by_options.action": "Anar al ecran de las configuracions del chat",
	"chat_restriction.disabled_by_launcher": "Chat restrench pel lançador",
	"chat_restriction.disabled_by_profile": "Chat restrench dins las opcions del perfil.",
	"chat_restriction.disabled_by_profile.action": "Anar al ecran de las configuracions del perfil",
	"chat_screen.commands_not_allowed": "Lo mandadís de comandas es pas autorizat",
	"chat_screen.message": "Messatge d'enviar: %s",
	"chat_screen.messages_not_allowed": "Lo mandadís de messatge es pas autorizat",
	"chat_screen.restricted": "Chat restrench. Clicatz sul messatge per ne saber mai.",
	"chat_screen.restricted.narration": "Chat restrench. Anatz al ecran dels restriccions dins las opcions del mond.",
	...
	"command.failed": "Una mèuca inesperada se produsís en ensajant de complir aquela comanda",
	...
	"commands.datapack.create.already_exists": "Un paquet amb lo nom \"%s\" ja existís",
	"commands.datapack.create.invalid_full_name": "\"%s\" es pas un nom valid per un paquet",
	"commands.datapack.create.invalid_name": "Caractèrs pas valids dins lo nom del paquet novèl \"%s\"",
	"commands.datapack.create.io_failure": "Se pòt pas crear un paquet amb lo nom \"%s\", consultatz lo registre",
	"commands.datapack.create.metadata_encode_failure": "Fracàs al temps del encodatge pel paquet amb lo nom \"%s\" : %s",
	"commands.datapack.create.success": "Creacion d'un novèl paquet amb lo nom \"%s\"",
	"commands.datapack.disable.failed": "Lo paquet de donada \"%s\" es pas activat!",
	"commands.datapack.disable.failed.feature": "Lo paquet de donada \"%s\" pòt pas èsser desactivat, perque fa partit d'una variable activa!",
	"commands.datapack.enable.failed": "Lo paquet de donada \"%s\" es ja actiu!",
	"commands.datapack.enable.failed.no_flags": "Lo paquet de donada \"%s\" pòt pas èsser activat, perque las variablas requesidas son pas activadas dins aquel mond : %s!",
	...
	"commands.datapack.unknown": "Paquet de donada desconegut \"%s\"",
	...
	"commands.fetchprofile.entity.success": "Perfil resòut per l'entitat \"%s\" : %s",
	...
	"commands.fetchprofile.id.failure": "Fracàs de la resolucion del perfil pel ID %s",
	"commands.fetchprofile.id.success": "Perfil resòut pel ID \"%s\" : %s",
	"commands.fetchprofile.name.failure": "Fracàs de la resolucion del perfil pel nom %s",
	"commands.fetchprofile.name.success": "Perfil resòut pel nom \"%s\" : %s",
	...
	"commands.gamerule.query": "La règla de jòc %s es definida sus : %s",
	...
	"commands.place.feature.failed": "Fracàs del plaçament del element",
	...
	"commands.place.jigsaw.failed": "Fracàs de la generacion del puzzle",
	...
	"commands.profile_fetch.id.failure": "Fracàs de la resolucion del perfil pel ID %s",
	"commands.profile_fetch.id.success": "Perfil resòut pel ID \"%s\" : %s",
	"commands.profile_fetch.name.failure": "Fracàs de la resolucion del perfil pel nom %s",
	"commands.profile_fetch.name.success": "Perfil resòut pel nom \"%s\" : %s",
	...
	"commands.publish.alreadyPublished.online": "Lo jòc multijogaire es ja albergat",
	...
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Lo format numeric per defaut %s es estat escafat",
	...
	"commands.swing.failed.notliving": "Pas cap de entitat trobada en trin de nadar",
	...
	"death.attack.spear.item": "%[1]s es estat traucat per %[2]s amb %[3]s",
	...
	"disconnect.loginFailedInfo.invalidSession": "Session pas valida (Ensajatz de tornar iniciar vòstre jòc e lo lançador)",
	...
	"entity.minecraft.area_effect_cloud": "Nívol d'efèit persistant",
	...
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla se los jogaires pòdon anar dins lo Nether.",
	...
	"gamerule.pvp.description": "Controla se los jogaires pòdon nafrar los autres jogaires.",
	...
	"gamerule.spawnMonsters.description": "Controla se los mostres pòdon aparéisser naturalament.",
	...
	"gui.friends.error.unauthorized": "Geton pas valid, tornatz iniciar vòstre jòc e lo lançador e tornatz ensajar",
	...
	"gui.friends.manage_account_footer": "Administratz vòstra seguritat en linha amb vòstra %s",
	...
	"gui.privacy_link.message": "Dobrissètz aquel ligam per administrar vòstres paramètres de confidencialitat e de securitat en linha.",
	"gui.privacy_link.title": "Los cambiaments dels paramètres Xbox pòdon prene de temps per s'aplicar.\n\nSe s'aplican pas, tornatz iniciar lo vòstre jòc.",
	...
	"mco.compatibility.unverifiable.message": "La version amb la quina aqueste mond foguèt jogat pel darrèr còp a pas pogut èsser verificada. Se lo mond es actualizat o retrogradat, una còpia de securetat serà creada automaticament e sauvagardada dins \"Còpias de securetat dels monds\".",
	"mco.compatibility.unverifiable.title": "La compatibilitat pòt pas èsser verificada",
	"mco.compatibility.upgrade": "Melhorament",
	"mco.compatibility.upgrade.description": "Aqueste mond foguèt jogat pel darrèr còp amb la version %s, sètz en version %s.\n\nUna còpia de securetat de vòstre mond serà sauvagardada dins \"Còpias de securetat del mond\".\n\nMercé de restaurar vòstre mond se es necessari.",
	"mco.compatibility.upgrade.friend.description": "Aqueste mond foguèt jogat pel darrèr còp amb la version %s, sètz en version %s.\n\nUna còpia de securetat de vòstre mond serà sauvagardada dins \"Còpias de securetat del mond\".\n\nLo proprietari del Realm pòt restaurar lo mond se es necessari.",
	...
	"mco.configure.world.spawn_toggle.message.npc": "Desactivar aquesta opcion suprimirà totas las entitats existentas d'aquel tipe, còma los vilatgers",
	...
	"mco.reset.world.template": "Modèles de mond",
	...
	"mco.snapshot.friendsRealm.downgrade": "Devetz èsser sus la version %s per rejónher aqueste Realm",
	...
	"mco.template.select.none": "Ops, sembla que lo que'aquesta categoria es voida a l'ora d'ara.\nSe vos plai, verificatz mai tard per de contengut novèl, o se sètz un creator,\n%s.",
	...
	"menu.multiplayerOptions.network.lan.tooltip": "Los jogaires sus lo meteis ret pòdon rejònher aquel mond.",
	...
	"multiplayer.disconnect.code_of_conduct": "Aquest servidor exigís qu'accèptatz lo còde de conducha",
	...
	"options.cutoutLeaves.tooltip": "Permés de véser a travèrs l'espaci entre las fuèlhas. Desactivar aquela opcion pòt melhorar las performàncias.",
	...
	"options.glintSpeed.tooltip": "Contraròtle la velocitat del scintilhament dels objèctes encantats.",
	...
	"options.graphics.fabulous.tooltip": "Los grafismes \"%s\" emplegan los ombrejaires per dessenhar los nívols e las particulas, coma aquelas de la meteo, darrèr los blòcs translucids.\nPòt impactar fòrça las qualitats tecnicas dels aparelhs portables e dels ecrans 4K.",
	"options.graphics.fancy": "Detalhats",
	"options.graphics.fancy.tooltip": "Los grafismes \"Detalhats\" porgisson un equilibri entre qualitats tecnicas e graficas per la magèr part dels aparelhs.\nLo temps atmosferic e las particulas, que las del temps atmosferic, pòdon o pas aparreisser darrèr los blòcs lindes e l'aiga.",
	...
	"options.graphicsApi.restart": "Devètz tornar iniciar vòstra jòc per cambiar l'API grafica.",
	...
	"options.improvedTransparency.tooltip": "Un apròchi experimental qu'emplega d'ombrejaires d'ecran per dessenhar lo temps atmosferic, los nívols e las particulas darrèr los blòcs lindes e l'aiga.\nAquò impactarà las performanças de la carta grafica.",
	...
	"options.needsRestart": "A besonh de tornar inciciar lo jòc.",
	...
	"options.restartRequired": "D'unes cambiaments an besonh de tornar inciciar lo jòc.",
	...
	"recover_world.no_fallback": "Pas cap d'estat a recobrar disponible",
	...
	"selectWorld.backupWarning.snapshot": "Aquel mond foguèt jogat en darrèr en version %s, sètz sus la snapshot %s. Mercé de far una sauvagarda en cas que lo mond serià corromput.",
	...
	"selectWorld.recreate.error.text": "Una mèuca se produsís en ensajant de tornar creat un mond.",
	"selectWorld.recreate.error.title": "Una error s'es produsida!",
	"selectWorld.requiresFileFixingTooltip.edit": "Aqueste mond deu èsser mes a jorn a la darrèra version abans d'èsser modificat. Es degut a de cambiaments al format del mond.",
	"selectWorld.requiresFileFixingTooltip.play": "Aqueste mond deu èsser mes a jorn a la darrèra version abans d'i jogar. Es degut a de cambiaments al format del mond.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Aqueste mond deu èsser mes a jorn a la darrèra version abans d'èsser tornat creat. Es degut a de cambiaments al format del mond.",
	...
	"selectWorld.warning.deprecated.question": "D'unas fonctionalitats emplegadas son obsoletas e foncionaràn pas mai a l'avenidor. Volètz contunhar?",
	...
	"selectWorld.warning.lowDiskSpace.title": "Atencion! Espaci de disc feble!",
	...
	"subtitles.block.respawn_anchor.ambient": "Acora de reaparicion que brusís",
	"subtitles.block.respawn_anchor.charge": "Acora de reaparicion cargada",
	"subtitles.block.respawn_anchor.deplete": "Acora de reaparicion que s'agota",
	...
	"subtitles.entity.allay.ambient_with_item": "Allay que cerca",
	...
	"subtitles.entity.generic.wind_burst": "Carga de vent peta",
