...
Plans:
- [ ] 25-01-PLAN.md — level/recipe data embed + parse (ALL types) + the 1:1 match (shaped shrink+mirror, shapeless multiset, cooking/stonecutting) + the value-returning Match seam in plugin/host (Wave 1)
...
| 25. Crafting/recipes AS plugins (2nd-domain dogfood) | v4 | 0/3 | Planned | — |
