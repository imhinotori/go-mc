...
var Map = map[string]string{
	...
	"debug.crash.message.rebindable": "Клавиши %s + %s зажаты. Это вызовет сбой игры, если не отпустить.",
	...
	"gui.friends.error.rateLimited.message": "Слишком много взаимодействий со списком друзей. Попробуйте ещё раз позже.",
	"gui.friends.error.temporary_unavailable": "В настоящий момент список друзей не работает.\n\nПопробуйте позже.",
	"gui.friends.error.unauthorized": "Указан недействительный токен. Перезапустите игру и лаунчер и попробуйте снова",
	...
	"gui.friends.manage_account_footer": "Для управления безопасностью подключения по сети используется ваш %s",
	...
	"gui.friends.narration.entry.incoming": "Входящий запрос в друзья от %s",
	...
	"gui.friends.presence.status.playing_hosted_server": "В локальной сети",
	"gui.friends.presence.status.playing_offline": "В мире",
	"gui.friends.presence.status.playing_realms": "В реалме",
	"gui.friends.presence.status.playing_server": "На сервере",
	...
	"gui.friends.toast.generic_error": "Произошла неизвестная ошибка при обновлении списка друзей. Попробуйте повторить попытку позже.",
	...
	"menu.multiplayerOptions.otherPlayers.header": "Настройки для других игроков",
	...
	"options.allowFriendRequests": "Принимать запросы",
	...
	"options.inGameNotification.tooltip": "Уведомления от друзей",
	...
	"options.multiplayer.title": "Открыть для локальной сети",
	...
	"options.sharePresence.all": "Полный",
	"options.sharePresence.all.tooltip": "Друзья видят, во что вы играете.",
	"options.sharePresence.limited": "Частичная",
	"options.sharePresence.limited.tooltip": "Друзья видят, когда вы в сети, но не видят, во что вы играете.",
	"options.sharePresence.none": "Скрытая",
	"options.sharePresence.none.tooltip": "Друзья всегда будут видеть вас не в сети.",
	...
	"options.worldOptions.game_mode.disabled.operator.tooltip": "Для изменения режима игры требуются права оператора.",
	...
	"subtitles.entity.small_sulfur_cube.eat": "Серный кубик прибавляет в весе",
	...
	"subtitles.item.spear.lunge": "Выпад копьём",
