...
var Map = map[string]string{
	...
	"gui.friends.validation.already_incoming": "Гулец %s ужо адправіў вам запыт сяброўства",
	"gui.friends.validation.already_outgoing": "Запыт сяброўства гульцу %s ужо адпраўлены",
	"gui.friends.validation.cannot_add_self": "Вы не можаце адправіць запыт сяброўства самому сабе",
