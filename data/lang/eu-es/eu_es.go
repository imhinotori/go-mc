...
var Map = map[string]string{
	...
	"editGamerule.inGame.disabled.hardcore.tooltip": "Ezin dira jokoaren arauak aldatu mundu gogor batean.",
	...
	"options.worldOptions.game_mode.disabled.tooltip": "Ezin dira jokoaren modua aldatu mundu gogor batean.",
