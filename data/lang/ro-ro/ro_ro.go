...
var Map = map[string]string{
	...
	"gui.abuseReport.draft.title": "Editezi schița de sesizare chat?",
	...
	"gui.friends.error.unauthorized": "Token nevalid; repornește jocul și lansatorul și încearcă din nou",
