...
var Map = map[string]string{
	...
	"gui.friends.validation.already_friend": "%s 已處於你的朋友列表中",
	"gui.friends.validation.already_incoming": "%s 已向你傳送交友請求",
	"gui.friends.validation.already_outgoing": "你已向 %s 傳送交友請求",
