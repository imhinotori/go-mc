...
var Map = map[string]string{
	...
	"options.graphicsApi.tooltip": "De bij het renderen gebruikte grafische API. Laat dit op standaard, tenzij je dit móét wijzigen!",
	...
	"options.worldOptions.game_mode.disabled.operator.tooltip": "Je moet een beheerder zijn om de spelmodus te veranderen.",
