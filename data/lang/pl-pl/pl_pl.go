...
var Map = map[string]string{
	...
	"gui.friends.presence.status.playing_hosted_server": "Online (w świecie LAN)",
	...
	"options.worldOptions.game_mode.disabled.tooltip": "Nie można zmieniać trybu gry w świecie hardcore.",
	...
	"subtitles.entity.small_sulfur_cube.eat": "Mała kostka siarki rośnie",
	...
	"title.multiplayer.online": "Gra wieloosobowa (online)",
