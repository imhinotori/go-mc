...
var allFourMobs = []struct {
	...
	// perch_search@13 (20 goalSelector) + defend_trusted@3 + land_target@4 + turtle_egg_target@4 + fish_target@6
	// (4 targetSelector). The village-stroll goal remains cite-deferred (no village POI subsystem).
	{vanillaFoxMobName, entity.Fox.ID, 20, 4},
