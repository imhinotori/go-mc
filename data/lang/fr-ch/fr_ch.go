...
var Map = map[string]string{
	...
	"advancements.story.mine_stone.title": "Le caillou !",
	...
	"commands.reload.failure": "Échec du rechargement, les données initiales sont conservées",
	...
	"commands.unpublish.success": "La partie multijoueur a été dépubliée",
	...
	"commands.worldborder.center.failed": "Aucune modification, la bordure du monde est déjà centrée ici",
	...
	"commands.worldborder.set.shrink": "Rétrécissement de la bordure du monde à %s bloc(s) de large sur %s seconde(s)",
	...
	"connect.failed.transfer": "Échec de la connexion pendant le transfert vers le serveur",
	...
	"connect.p2p.failed.signaling": "Il n'est pas possible de se connecter actuellement.\nRéessayez plus tard.",
	"connect.p2p.failed.timeout": "Requête de connexion expirée",
	"connect.p2p.failed.unreachable": "Ce joueur est inatteignable",
	...
	"death.attack.explosion": "%[1]s s'est fait exploser",
	"death.attack.explosion.player": "%[1]s s'est fait exploser par (un(e)) %[2]s",
	"death.attack.explosion.player.item": "%[1]s a péri dans une explosion causée par (un(e)) %[2]s en utilisant %[3]s",
	...
	"debug.options.warning": "Ces paramètres ne servent qu'à des fins de tests. Ils peuvent ralentir votre ordinateur, faire planter le jeu ou manger votre goûter.",
	...
	"difficulty.lock.question": "Êtes-vous sûr de vouloir verrouiller la difficulté de ce monde ? Cela bloquera ce monde pour toujours en %[1]s, vous ne serez plus capable de le modifier de nouveau.",
	...
	"gui.friends.presence.status.playing_hosted_server": "En ligne (réseau local)",
	...
	"menu.multiplayerOptions.button": "Ouvrir au réseau local",
	...
	"options.worldOptions.game_mode.disabled.operator.tooltip": "Le changement du mode de jeu requiert les permissions d'opérateur.",
