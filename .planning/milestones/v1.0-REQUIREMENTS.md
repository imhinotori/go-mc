...
- [x] **PARITY-01**: Mojang density-function world generation (improved-Perlin/OctaveSimplex) for terrain parity — ✅ DELIVERED in v1.0 (Phase 9): real client explores biome-varied noise terrain with caves/ravines/aquifers/ore-veins; per-marker interpolation + surface-before-carve fidelity fixes applied (aa619b81); visual gate approved
...
| ONLINE-01 (v2) | Phase 9 | Deferred → v2 |
| ONLINE-02 (v2) | Phase 9 | Deferred → v2 |
| PARITY-01 | Phase 9 | ✅ Complete (delivered v1.0) |
| REGION-01 (v2) | Phase 9 | Deferred → v2 |
