...
var Map = map[string]string{
	...
	"commands.defaultgamemode.success": "La modalità di gioco predefinita è stata impostata su «%s»",
	...
	"commands.difficulty.success": "La difficoltà è stata stata impostata su «%s»",
	...
	"commands.scoreboard.objectives.modify.rendertype": "Il tipo di elaborazione grafica dell'obiettivo %s è stato cambiato",
	...
	"commands.tick.status.lagging": "Il gioco è in esecuzione, ma non riesce a tenere il passo con la frequenza dei tick indicata",
	...
	"debug.options.category.renderer": "Visualizzazioni di debug",
	...
	"gui.friends.error.unauthorized": "Gettone d'accesso non valido. Riavvia il gioco e il launcher prima di riprovare",
	...
	"gui.friends.presence.status.playing_hosted_server": "In linea (locale)",
	...
	"test_block.mode_info.fail": "Fallimento: fa' fallire il test",
