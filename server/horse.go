...
func newHorseFamilyAI(baseSpeed float64) *mobAI {
	...
	m.goals.addGoal(3, newTemptGoal(horseTemptSpeed, func(id int32) bool { return itemInTag(id, horseTemptItemsTag) }, false))
...
func newLlamaAI() *mobAI {
	...
	m.goals.addGoal(5, newTemptGoal(horseTemptSpeed, func(id int32) bool { return itemInTag(id, llamaTemptItemsTag) }, false))
