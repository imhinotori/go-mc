// Code generated by tools/gen_item_max_damage.go from 26.2/reports/minecraft/components/item/*.json; DO NOT EDIT.

package item

// DefaultMaxDamage maps an item resource id (e.g. "minecraft:diamond_pickaxe") to its DEFAULT
