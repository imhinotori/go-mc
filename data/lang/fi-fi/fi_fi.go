...
var Map = map[string]string{
	...
	"gui.friends.error.unauthorized": "Annettu virheellinen token, käynnistä peli ja launcher uudelleen ja yritä uudestaan",
	...
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Signaloidaan yhdistysaikaa (Millisekuntteina)",
